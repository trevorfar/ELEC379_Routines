    ...
    void merge(int A[], int p, int q, int r) {
        //p = start index, q = middle, r = end index
    ...
    void merge_sort(int A[], int p, int r) {
        if (p < r) {
            ...
            merge_sort(A, p, q); // recursion to split them up into individual sub arrays
            merge_sort(A, q + 1, r); // recursion to split them up into individual sub arrays
